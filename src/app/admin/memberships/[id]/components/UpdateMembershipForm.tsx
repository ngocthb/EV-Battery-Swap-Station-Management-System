...
const UpdateMembershipForm: React.FC<UpdateMembershipFormProps> = ({
  membershipId,
}) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.success) {
        toast.success(response.message || "Cập nhật gói thành công!");
    ...
    return (
      <div className="bg-white rounded-lg shadow-sm border border-gray-200">
        <div className="flex items-center justify-center py-12">
          ...
          <span className="ml-2 text-gray-600">Đang tải thông tin gói...</span>
        </div>
      </div>
    );
  }
      ...
      <form onSubmit={handleSubmit} className="p-6">
        ...
        <div className="flex justify-end space-x-3 mt-8 pt-6 border-t border-gray-200">
          ...
          >
            ...
            <span>{loading ? "Đang cập nhật..." : "Cập nhật gói"}</span>
          </button>
        </div>
      </form>
    </div>
