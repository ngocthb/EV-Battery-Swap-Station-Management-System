...
const DeleteConfirmModal: React.FC<DeleteConfirmModalProps> = ({
  ...
  if (!deleteModal.isOpen || !batteryType) return null;
  ...
  const handleDeleteConfirm = async () => {
    ...
    try {
      const response = await onConfirmAPI((deleteModal.data as BatteryType).id);
      if (response.success) {
        ...
        <div className="p-6">
          ...
          <div className="bg-red-50 border border-red-200 rounded-lg p-3">
            <p className="text-sm text-red-800">
              <strong>Cảnh báo:</strong> Việc xóa loại pin sẽ xóa tất cả dữ liệu
